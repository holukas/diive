...
to a threshold, useful for quality control and analysis of ecosystem processes
...
# ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#
# This example shows how to identify daytime and nighttime periods based on
# solar elevation angle and potential radiation. Different thresholds can be
...
# ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#
# Display spatial-temporal patterns of daytime/nighttime flags and potential
# radiation across the entire measurement period.
