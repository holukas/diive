...
.. "auto_examples\gap_filling\mds_comparison.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_gap_filling_mds_comparison.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_gap_filling_mds_comparison.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 18-319



.. image-sg:: /auto_examples/gap_filling/images/sphx_glr_mds_comparison_001.png
   :alt: FluxMDS Performance Comparison: Original vs Optimized, Execution Time Comparison, Performance Improvement, Prediction Value Differences, Quality Flag Distribution (Match Check), Gap-Filled Values Comparison
   :srcset: /auto_examples/gap_filling/images/sphx_glr_mds_comparison_001.png
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Dataset: July 2022 (1,488 records)
    Flux variable: NEE_CUT_REF_orig
    Missing values: 770 (51.7%)
    ...
    ----------------------------------------------------------------------
    Execution time (seconds)                       1.17            0.25
    Speedup factor                                 1.0x             4.8x
    Time saved                                    0.00s           0.92s

    ======================================================================
                      Result Validation (Accuracy Check)                  
    ======================================================================

    Prediction differences (n=1488 matching values):
      Absolute difference                 max=       3.28e-01 mean=       3.94e-04
      Relative difference                 max=       2.86e-02 mean=       3.76e-05
      Match tolerance                     PASS (< 1.0)

    Standard deviation differences (n=1488 matching values):
      Absolute difference                 max=       1.12e-01 mean=       1.32e-04
      Relative difference                 max=       4.06e-02 mean=       4.39e-05
      Match tolerance                     PASS (< 1.0)

    Prediction counts match: FAIL
    Quality flags match: PASS

    Final gap-filled values:
      Difference                          max=       1.78e-15 mean=       1.74e-16

    ======================================================================
                                   Summary                                
    ======================================================================

    Speedup: 4.8x faster (0.92s saved)
    Result accuracy: PASS - Results are bit-identical
    Both gap-filling methods completed successfully
...
.. _sphx_glr_download_auto_examples_gap_filling_mds_comparison.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: mds_comparison.ipynb <mds_comparison.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: mds_comparison.py <mds_comparison.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: mds_comparison.zip <mds_comparison.zip>`
