...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_createvar_noise.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_createvar_noise.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 7-238
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /auto_examples/createvar/images/sphx_glr_noise_001.png
         :alt: Synthetic Time Series: Default Parameters
         :srcset: /auto_examples/createvar/images/sphx_glr_noise_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/createvar/images/sphx_glr_noise_002.png
         :alt: Strong Trend & Seasonality Low Noise, Weak Trend & Seasonality High Noise
         :srcset: /auto_examples/createvar/images/sphx_glr_noise_002.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/createvar/images/sphx_glr_noise_003.png
         :alt: Before: Clean Time Series, After: With Impulse Noise (5% contamination)
         :srcset: /auto_examples/createvar/images/sphx_glr_noise_003.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/createvar/images/sphx_glr_noise_004.png
         :alt: Synthetic Time Series Components
         :srcset: /auto_examples/createvar/images/sphx_glr_noise_004.png
         :class: sphx-glr-multi-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Running noise generation examples...

    1. Generate synthetic time series (default parameters)...
    Generated synthetic time series (daily frequency, 365 days):
    Shape: (365, 3)
    Columns: ['base_signal', 'noise', 'observed_value']
    Data range: -6.73 to 36.54

    2. Generate with custom parameters...
    Strong trend & seasonality, low noise:
    Mean: 36.48, Std: 21.64
    Weak trend, high noise:
    Mean: 1.83, Std: 9.81

    3. Add impulse noise to clean series...
    Added impulse noise to clean time series:
    Original max deviation: 12.94
    With impulse noise max deviation: 98.88
    Impulse-affected points: ~18 out of 365
...
.. _sphx_glr_download_auto_examples_createvar_noise.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: noise.ipynb <noise.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: noise.py <noise.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: noise.zip <noise.zip>`
