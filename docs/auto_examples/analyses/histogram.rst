...
.. "auto_examples\analyses\histogram.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_analyses_histogram.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_analyses_histogram.py:
...
.. _sphx_glr_download_auto_examples_analyses_histogram.py:
