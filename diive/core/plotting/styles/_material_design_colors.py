...
def red(shade):
    """Return the Material Design 'red' colour hex for the given *shade* id."""
    c = {50: '#ffebee',
...
def pink(shade):
    """Return the Material Design 'pink' colour hex for the given *shade* id."""
    c = {50: '#FCE4EC',
...
def purple(shade):
    """Return the Material Design 'purple' colour hex for the given *shade* id."""
    c = {50: '#F3E5F5',
...
def deeppurple(shade):
    """Return the Material Design 'deeppurple' colour hex for the given *shade* id."""
    c = {50: '#EDE7F6',
...
def indigo(shade):
    """Return the Material Design 'indigo' colour hex for the given *shade* id."""
    c = {50: '#E8EAF6',
...
def blue(shade):
    """Return the Material Design 'blue' colour hex for the given *shade* id."""
    c = {50: '#e3f2fd',
...
def lightblue(shade):
    """Return the Material Design 'lightblue' colour hex for the given *shade* id."""
    c = {50: '#E1F5FE',
...
def cyan(shade):
    """Return the Material Design 'cyan' colour hex for the given *shade* id."""
    c = {50: '#E0F7FA',
...
def teal(shade):
    """Return the Material Design 'teal' colour hex for the given *shade* id."""
    c = {50: '#E0F2F1',
...
def green(shade):
    """Return the Material Design 'green' colour hex for the given *shade* id."""
    c = {50: '#E8F5E9',
...
def lightgreen(shade):
    """Return the Material Design 'lightgreen' colour hex for the given *shade* id."""
    c = {50: '#F1F8E9',
...
def lime(shade):
    """Return the Material Design 'lime' colour hex for the given *shade* id."""
    c = {50: '#F9FBE7',
...
def yellow(shade):
    """Return the Material Design 'yellow' colour hex for the given *shade* id."""
    c = {50: '#FFFDE7',
...
def amber(shade):
    """Return the Material Design 'amber' colour hex for the given *shade* id."""
    c = {50: '#FFF8E1',
...
def orange(shade):
    """Return the Material Design 'orange' colour hex for the given *shade* id."""
    c = {50: '#FFF3E0',
...
def deeporange(shade):
    """Return the Material Design 'deeporange' colour hex for the given *shade* id."""
    c = {50: '#FBE9E7',
...
def brown(shade):
    """Return the Material Design 'brown' colour hex for the given *shade* id."""
    c = {50: '#EFEBE9',
...
def gray(shade):
    """Return the Material Design 'gray' colour hex for the given *shade* id."""
    c = {50: '#FAFAFA',
...
def bluegray(shade):
    """Return the Material Design 'bluegray' colour hex for the given *shade* id."""
    c = {50: '#ECEFF1',
