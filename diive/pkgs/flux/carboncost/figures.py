...
def _plot_nee_vs_vpd(ax, results, linecrossings_aggs, thres_chd, num_chds):
    """Plot NEE vs VPD"""
    ...
    line_xy_nee, line_fit_nee, line_fit_ci_nee, line_fit_pb_nee = \
        fitplot(ax=ax, label='NEE',
                x=results['nee']['x'],
                y=results['nee']['y'],
                fitx=results['nee']['fit_df']['fit_x'],
                fity=results['nee']['fit_df']['nom'],
                fity_ci95_lower=results['nee']['fit_df']['nom_lower_ci95'],
                fity_ci95_upper=results['nee']['fit_df']['nom_upper_ci95'],
                fity_pb_lower=results['nee']['fit_df']['lower_predband'],
                fity_pb_upper=results['nee']['fit_df']['upper_predband'],
